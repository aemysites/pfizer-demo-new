...
## Environments
- Preview: https://main--pfizer-demo-new--aemysites.aem.page/
- Live: https://main--pfizer-demo-new--aemysites.aem.live/
- Block Library: https://main--pfizer-demo-new--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `pfizer-demo-new` directory in your favorite IDE and start coding :)
